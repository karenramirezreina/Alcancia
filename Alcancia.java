...
public class Alcancia {
    ...
    public int obtenerDenominacionMasNumerosa() {
      int max = Math.max(numeroMonedas50, Math.max(numeroMonedas100, Math.max(numeroMonedas200, Math.max(numeroMonedas500, numeroMonedas1000))));
    ...
    public boolean valiosa() {
         return (numeroMonedas50 == 0 && numeroMonedas200 == 0 && numeroMonedas100 == 0) &&
